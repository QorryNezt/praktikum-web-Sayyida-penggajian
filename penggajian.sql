...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 31, 2024 at 02:50 AM
...
('0001', 'WACHID', '2015-01-01', 3000000, 'TETAP', 3),
...
('0010', 'ARMAND', '2024-10-20', 2500000, 'TETAP', 3),
...
CREATE TABLE `kosong` (
  `id` int(11) NOT NULL,
  `untuk_uji_coba_kosong` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `karyawan`
  ADD CONSTRAINT `karyawan_ibfk_1` FOREIGN KEY (`bagian_id`) REFERENCES `bagian` (`id`);
COMMIT;
